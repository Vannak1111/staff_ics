...
class ProfileController extends GetxController {
  ...
  Future fetchProfile({required String apiKey}) async {
    try {
      String fullUrl = dotenv.get('baslurl_school') + getProfile;
  ...
  Future userLogin(String email, String password, String firebaseToken) async {
    ...
    try {
      String fullUrl = dotenv.get('baslurl_school') + login;
  ...
  Future userChangePassword(String _oldPassword, String _newPassword) async {
    try {
      String fullUrl = dotenv.get('baslurl_school') + changePassword;
      var response = await Dio(BaseOptions(headers: {
        "Accept": "application/json",
      ...
      ChangePasswordDb changePasswordDb =
          ChangePasswordDb.fromMap(response.data);
